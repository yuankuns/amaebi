...
/// path without shelling out.  The override is checked at runtime (not
/// gated behind `#[cfg(test)]`) so integration tests that spawn the
/// daemon as a subprocess can inject it via the process environment.
